                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="glyphicon glyphicon-briefcase"></span> REALIZAR COMPRAS</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class= "col-md-2 col-md-offset-9">
                            <p>
                                ...
                                <span class="glyphicon glyphicon-floppy-saved"></span>> Registrar Compra</button>
                            </p>
                        </div>
                    </div>    
                </div> 
